...
student, names, cohort_name, start_date, student_cohort
```
...
```sql
-- file: students_discovery_table.sql
...
```bash
psql -h 127.0.0.1 student_directory_2 < student_discovery_table.sql
```